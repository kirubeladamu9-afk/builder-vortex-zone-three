    ...
    <div className="mt-4 flex flex-col gap-6 rounded-2xl bg-background/80 p-5">
      ...
      <div className="grid gap-3 text-sm">
        ...
        <div className="flex items-center justify-between rounded-2xl bg-accent/60 px-4 py-3">
          ...
          <span className="font-display text-lg text-foreground">07:45 min</span>
        </div>
...
const PhaseCard = ({
  ...
  <Card className="h-full border-border/60 bg-card/80 p-6 shadow-lg shadow-primary/5 backdrop-blur">
    <div className="flex items-center justify-between">
      <Badge variant="secondary" className="rounded-full border-none px-3 py-1 text-xs font-semibold">
        {phase}
      </Badge>
    ...
    <div className="mt-6 space-y-5">
      {highlights.map(({ title: itemTitle, description, icon: Icon }, index) => (
        <div
          key={itemTitle}
...
export default function Index() {
  return (
    <div className="relative overflow-hidden">
        ...
        <div className="container grid items-center gap-12 py-16 md:grid-cols-2 md:py-24">
          <div className="space-y-8">
            ...
            <h1 className="font-display text-4xl font-semibold tracking-tight text-foreground sm:text-5xl lg:text-6xl">
              Keep your queues moving with <span className="bg-gradient-to-r from-primary via-sky-500 to-indigo-500 bg-clip-text text-transparent">QR smart tickets</span>
            </h1>
            <p className="max-w-xl text-lg text-muted-foreground">
              Give every guest a personal status page they can scan anytime. Replace phone-dependent updates with intuitive QR codes and ambient displays that keep everyone relaxed and ready.
            </p>
            <div className="flex flex-wrap items-center gap-4">
              ...
              <Button asChild variant="outline" size="lg" className="h-12 border-border/70 bg-background/70 px-6 text-base">
      ...
      <section id="journey" className="relative border-t border-border/60 bg-foreground/5 py-20 md:py-24">
        ...
        <div className="container space-y-12">
          <div className="max-w-2xl space-y-4">
            <Badge variant="secondary" className="rounded-full border-none px-4 py-1 text-xs font-semibold">
            ...
            <p className="text-lg text-muted-foreground">
              Every action from arrival to service is captured in a guided workflow. QR codes become living tickets—updating the moment staff move the queue forward.
            </p>
          </div>
      ...
      <section className="relative py-20 md:py-24">
        <div className="container grid gap-12 lg:grid-cols-[1.1fr,0.9fr] lg:items-center">
          <div className="space-y-6">
            ...
            <p className="text-lg text-muted-foreground">
              Customers can scan or simply glance at the lobby display. Meanwhile, staff get instant alerts for priorities, so nobody waits unsure of what happens next.
            </p>
            <div className="grid gap-4 sm:grid-cols-2">
              <div className="rounded-2xl border border-primary/30 bg-primary/5 p-5 text-sm text-primary">
                ...
                <p className="mt-3 text-primary/80">
                  Guests move freely, confident that a quick scan or glance tells them exactly what to do next.
                </p>
              </div>
              <div className="rounded-2xl border border-accent/40 bg-accent/40 p-5 text-sm text-accent-foreground">
                ...
                <p className="mt-3 text-accent-foreground/80">
                  Machine learning refines wait predictions every five minutes using live throughput.
                </p>
              </div>
            </div>
          </div>
      ...
      <section id="analytics" className="relative border-y border-border/60 bg-foreground/5 py-20 md:py-24">
        ...
        <div className="container grid gap-10 lg:grid-cols-[0.9fr,1.1fr] lg:items-center">
          <div className="space-y-5">
            ...
            <p className="text-lg text-muted-foreground">
              A live dashboard shows throughput, average service times, and abandonments. Export data or trigger automations when thresholds are met.
            </p>
            <ul className="space-y-3 text-sm text-muted-foreground">
              <li className="flex items-center gap-2 text-foreground">
                <CheckCircle2 className="h-4 w-4 text-primary" /> Autocomplete service reports with window-level metrics.
              </li>
              <li className="flex items-center gap-2 text-foreground">
                <CheckCircle2 className="h-4 w-4 text-primary" /> Predict peak congestion with rolling forecasts.
              </li>
              <li className="flex items-center gap-2 text-foreground">
                <CheckCircle2 className="h-4 w-4 text-primary" /> Trigger SMS, email, or on-site notifications if SLAs slip.
              </li>
            </ul>
          </div>
          <div className="rounded-3xl border border-border/70 bg-background/70 p-8 shadow-xl shadow-primary/10">
            ...
            <div className="mt-8 grid gap-4 md:grid-cols-2">
              <div className="rounded-2xl border border-border/70 bg-card/80 p-4">
                <p className="text-xs uppercase text-muted-foreground">Average wait</p>
                <p className="mt-2 font-display text-2xl font-semibold text-foreground">
                  08:21 min
                </p>
                <p className="mt-1 text-xs text-muted-foreground">Down from 13:15 last month</p>
              </div>
              <div className="rounded-2xl border border-border/70 bg-card/80 p-4">
                <p className="text-xs uppercase text-muted-foreground">Abandonment rate</p>
                <p className="mt-2 font-display text-2xl font-semibold text-foreground">
                  1.7%
                </p>
                <p className="mt-1 text-xs text-muted-foreground">Goal: keep under 3%</p>
              </div>
              <div className="rounded-2xl border border-border/70 bg-card/80 p-4">
                <p className="text-xs uppercase text-muted-foreground">Service alignment</p>
                <p className="mt-2 font-display text-2xl font-semibold text-foreground">
                  98% on time
                </p>
                <p className="mt-1 text-xs text-muted-foreground">Window balancing automation engaged</p>
              </div>
              <div className="rounded-2xl border border-border/70 bg-card/80 p-4">
                <p className="text-xs uppercase text-muted-foreground">Feedback pulse</p>
                <p className="mt-2 font-display text-2xl font-semibold text-foreground">
                  4.8 / 5
                </p>
                <p className="mt-1 text-xs text-muted-foreground">Surveyed after completion</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section id="get-started" className="relative py-20 md:py-24">
        <div className="container grid gap-12 lg:grid-cols-[1.1fr,0.9fr] lg:items-center">
          <div className="space-y-5">
            ...
            <p className="text-lg text-muted-foreground">
              We deliver templates, staff scripts, and digital signage assets so your team can pilot without friction.
            </p>
            <div className="space-y-4">
              {["Configure services & windows", "Train reception with guided prompts", "Go live with beautiful lobby screens"].map((step, index) => (
                <div
                  key={step}
            ...
            <div className="flex flex-wrap items-center gap-3 pt-2 text-sm text-muted-foreground">
              <CheckCircle2 className="h-4 w-4 text-primary" /> Dedicated onboarding specialist included
            </div>
          </div>
          <div className="rounded-3xl border border-border/60 bg-card/80 p-8 shadow-xl shadow-primary/10">
            <h3 className="font-display text-2xl font-semibold text-foreground">Front-desk script</h3>
            <p className="mt-2 text-sm text-muted-foreground">
              “This is your virtual ticket. Scan it anytime to see your place in line. Please relax in the lounge—we&apos;ll notify you when it&apos;s your turn.”
            </p>
            ...
            <Button asChild size="lg" className="mt-8 h-12 w-full text-base shadow-lg shadow-primary/20">
      ...
      <section id="faq" className="relative border-t border-border/60 bg-foreground/5 py-20 md:py-24">
        <div className="container grid gap-12 lg:grid-cols-[0.9fr,1.1fr]">
          <div className="space-y-5">
            ...
            <p className="text-lg text-muted-foreground">
              From accessibility to multi-location deployment, QFlow gives teams everything needed to modernize the lobby experience.
            </p>
          </div>
          <Accordion type="single" collapsible className="w-full divide-y divide-border/60 rounded-3xl border border-border/60 bg-background/80">
            {FAQS.map((faq, index) => (
